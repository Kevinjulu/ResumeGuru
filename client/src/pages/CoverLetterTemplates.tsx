            ...
            {[
              {
                ...
                description: "All templates are designed by experts to impress recruiters.",
                icon: CheckCircle2,
              },
              {
              ...
              },
              {
                ...
                description: "Download your cover letter as PDF, Word, or TXT file instantly.",
                icon: Download,
              },
            ].map((feature, i) => (
...
function TemplateCard({ template, onUseTemplate }: { template: typeof coverLetterTemplates[number]; onUseTemplate: (templateId: string, colorId: string) => void }) {
